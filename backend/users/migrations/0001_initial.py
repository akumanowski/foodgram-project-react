    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(help_text='Ваше имя на сайте', max_length=150, unique=True, validators=[api.validators.model_validate_username], verbose_name='Имя пользователя')),
        ...
        migrations.AddConstraint(
            model_name='subscription',
            constraint=models.CheckConstraint(check=models.Q(('author', django.db.models.expressions.F('author')), _negated=True), name='no_self_subscription'),
        ),
    ]
